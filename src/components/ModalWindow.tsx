      ...
      <div className="modalWindow">
        ...
        <div className="modal-text">
          ...
          <div>
            ...
            применяя различные стратегии. <br />
            <br />
            На нашем сайте мы предлагаем вам возможность насладиться
            классической игрой в шахматы. Здесь нет онлайн-игры и ботов - только
            вы и ваш соперник за шахматной доской. Наша платформа создана
            специально для тех, кто ценит живое общение и личное противостояние
            за шахматной партией. Окунитесь в атмосферу интеллектуального
            соперничества и дружеского общения за игровой доской. <br />
            <br />
